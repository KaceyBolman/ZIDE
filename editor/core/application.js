...
var ZideApplication = Application.extend({
    el: null,
    ...
    initialize: function() {
        ZideApplication.__super__.initialize.apply(this, arguments);
        ...
        function updateOnlineStatus(event) {
            ...
            if (!navigator.onLine) {
                ...
                dialogs.alert("Your internet connection is up again. Restart your navigator tab to ensure that zide works perfectly.");
            }
        }
...
module.exports = new ZideApplication();
